...
export default class Game extends React.Component {
  ...
  constructor(props) {
    ...
    const width =
      this.props.initialGridSize > this.props.maxGridSize
        ? this.props.maxGridSize
        : this.props.initialGridSize;
      ...
      <div id="game" style={{ width: `${gridSize}px` }}>
        ...
        <div className="game-ctrl">
          ...
          <Resize
            ...
            resize={this.changeRow}
          />
          <Resize
            label="Columns:"
            number={this.state.cols}
            resize={this.changeCol}
          />
        </div>
        <div
  ...
  _windowResize = (event) => {
    const width =
      window.outerWidth > this.props.maxGridSize
        ? this.props.maxGridSize
        : window.outerWidth;
    this.setState({
